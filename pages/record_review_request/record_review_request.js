                ...
                <form action = "https://formsubmit.co/mattmcal88@gmail.com" method = "POST" name = "Record Request Form"> <br />
                    ...
                    <div class="field">
                        <label for = "recordname" class="label is-size-4 has-text-weight-normal"> Record Name </label>
                            <div class="control">
                                <input class="input is-medium is-success" id = "recordname" type="text" placeholder="Record Name" name = "Record Name"
                                required
                                minlength = "1"
                                maxlength = "125"
                                /> <br />
                    ...
                    <div class="field">
                        <label for = "bandname" class = "label is-size-4 has-text-weight-normal"> Band Name </label>
                            <div class="control">
                                <input class="input is-medium is-success" id = "bandname" type="text" placeholder="Band Name" name = "Band Name"
                                required
                                minlength = "1"
                                maxlength = "125"
                                /> <br />
