function recordReviewRequest()
{
    return (
        <body>
            <script defer src = "record_review_request_form_validation.js"></script>
            <div id = "error"></div>
            <section class = "section is-medium">
                <h1 class = "title has-text-weight-bold">
                    Request a Record for Review
                </h1>
                <form id = "form" action = "https://formsubmit.co/mattmcal88@gmail.com" method = "POST" name = "Record Request Form"> <br />
